...
requirements = python3,kivy=2.3.0,kivymd==0.104.1,sdl2_ttf,pillow
...
presplash.filename = %(source.dir)s/ball5.png

# (str) Icon of the application
icon.filename = %(source.dir)s/ball5.png
